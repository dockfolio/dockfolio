#!/usr/bin/env python3
"""Deploy Dockfolio banner injection to all 14 user-facing nginx site configs.
...
SITES = {
    ...
    "abfindungsoptimizer.de":("abfindungsoptimizer",  True),
    "schenkungsplaner.eu":   ("schenkungsplaner",     True),
