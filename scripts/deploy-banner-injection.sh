...
echo ""
echo "[2/4] Injecting banner system into 14 site configs"
...
inject_site "$NGINX_SITES/abfindungsoptimizer.de" "abfindungsoptimizer"  "proxy"  "abfindungsoptimizer.de"
inject_site "$NGINX_SITES/schenkungsplaner.eu"   "schenkungsplaner"      "proxy"  "schenkungsplaner.eu"
...
echo ""
echo "=== Banner injection deployed to 14 sites ==="
